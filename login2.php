...
<div class= principal>
  ...
  <div class="principal">
   <form class="registro" action="index.html" method="post"><br><br>
  <br>
   <input type="email" id= "email" name="email" value="" placeholder="E-mail o nombre de usuario"><br><br>
  <br>
  ...
  <h5>¿No tenes cuenta? <strong>Regístrate</strong></h5>
